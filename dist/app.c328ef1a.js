...
function NewsFeed() {
  ...
  for (var i = (store.currentPage - 1) * 10; i < store.currentPage * 10; i++) {
    newsList.push("\n            <div class=\"p-6 ".concat(newsFeed[i].read ? 'bg-red-500' : 'bg-white', " mt-6 rounded-lg shadow-md transition-colors duration-500 hover:bg-green-100\">\n                <div class=\"flex\">\n                    <div class=\"flex-auto\">\n                        <a href=\"#/show/").concat(newsFeed[i].id, "\">\n                            ").concat(newsFeed[i].title, "\n                        </a>\n                    </div>\n                    <div class=\"text-center text-sm\">\n                        <div class=\"w-10 text-white bg-green-300 rounded-lg px-0 py-2\">\n                            ").concat(newsFeed[i].comments_count, "\n                        </div>\n                    </div>\n                </div>\n                <div class=\"flex mt-3\">\n                    <div class=\"grid grid-cols-3 text-sm text-gray-500\">\n                        <div><i class=\"fas fa-user mr-l\">").concat(newsFeed[i].user, "</i></div>\n                        <div><i class=\"fas fa-heart mr-l\">").concat(newsFeed[i].points, "</i></div>\n                        <div><i class=\"fas fa-clock mr-l\">").concat(newsFeed[i].time_ago, "</i></div>\n                    </div>\n                </div>\n            </div>\n        "));
  }

  template = template.replace("{{__news_feed__}}", newsList.join(''));
  template = template.replace("{{__prev_page__}}", store.currentPage > 1 ? store.currentPage - 1 : 1);
  template = template.replace("{{__next_page__}}", store.currentPage < 3 ? store.currentPage + 1 : store.currentPage = 3); //template = template.replace("{{__next_page__}}", store.currentPage + 1);
...
router();
},{}],"C:/Users/MyeongJun/AppData/Roaming/npm/node_modules/parcel-bundler/src/builtins/hmr-runtime.js":[function(require,module,exports) {
...
},{}]},{},["C:/Users/MyeongJun/AppData/Roaming/npm/node_modules/parcel-bundler/src/builtins/hmr-runtime.js","app.js"], null)
